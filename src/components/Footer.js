    ...
    <div className="Footer-container d-flex align-items-center justify-content-between   pt-3 pb-3 container ">
        <div style={{ color: "rgb(107 114 128/1" }}>
          <h1 className=" " style={{ fontSize: "20px" }}>
            All right reserved - Developed by Pradheesh.S
          </h1>
        </div>
        <div className="">
          <a href="https://www.linkedin.com/in/pradheesh-s-415b1b255/" target="/blank">
            <img
          ...
          <a href="https://github.com/Pradheesh-S" target="/blank">
            <img
              className=" cursor-pointer me-3  "
              style={{ width: "35px" }}
              src={github}
